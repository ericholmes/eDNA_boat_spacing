...
stryker_startstop <- data.frame(boat = rep("stryker",6), 
                                ...
                                start = c(7, 57, 116, 152, 197, 233), 
                                end = c(53, 112, 148, 193, 229, 272))
...
phantom_startstop <- data.frame(boat = rep("phantom", 6), 
                                site = c(rep("812", 3), rep("809", 3)),
                                start = c(7, 75, 153, 204, 238, 267), 
                                end = c(71, 149, 200, 234, 263, 308))
...
cdfw_startstop <- data.frame(boat = rep("cdfw", 6), 
                             site = c(rep("812", 3), rep("809", 3)),
                             start = c(7,39,67,93,113,134), 
                             end = c(35,63,85,109,124,149))
...
png("output/eDNA_vessel_spacing_20250319.png",
...
png("output/eDNA_vessel_velocity_20250319.png",
