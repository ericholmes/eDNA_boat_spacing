...
for(xs in 1:nrow(stryker_startstop)){
  ...
  temp <- read.csv("data/Survey03_20250226/RouteHistoryFullBkup_DWR Feb26.csv", 
...
for(xs in 1:nrow(phantom_startstop)){
  ...
  temp <- read.csv("data/Survey03_20250226/20250226_RouteHistory_CFS.csv", 
